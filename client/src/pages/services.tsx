      ...
      <div className="container mx-auto px-6 py-20">
        ...
        <div className="border-t border-white/10 py-20 mb-16">
          <motion.div
            ...
            className="mb-16"
          >
            <h2 className="text-4xl font-display font-bold mb-6 text-center text-primary">Our Journey to Excellence</h2>
        ...
        <div className="border-t border-white/10 py-20 mb-0">
          <motion.div
            ...
            className="mb-16"
          >
            <h2 className="text-4xl font-display font-bold mb-4 text-center text-primary">Frequently Asked Questions</h2>
