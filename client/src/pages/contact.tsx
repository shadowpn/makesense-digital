  ...
  return (
    <Layout>
      ...
      <motion.a
        ...
        whileTap={{ scale: 0.95 }}
      >
        <div className="p-4 rounded-full bg-[#d2f7be]/15 border border-[#d2f7be]/30 text-primary shadow-lg shadow-purple-500/40 hover:shadow-xl hover:shadow-purple-500/60 hover:bg-[#d2f7be]/25 transition-all duration-300 flex items-center justify-center group">
